...
export function WhatsAppButton() {
  const message = encodeURIComponent(
    "Hi Pikzelkraft! I'd like to discuss a project."
  );
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-floating transition-transform duration-200 hover:scale-110 active:scale-95"
    >
